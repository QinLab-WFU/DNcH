...
def get_args():
    ...
    parser.add_argument("--dataset", type=str, default="nuswide", help="choise from [flickr25k ,coco, mirflckr25k, nuswide]")
    ...
    parser.add_argument("--YOCO", type=bool, default=True)
