...
jsonFile = '/home/zg/dataset/IAPRTC12/train.json'
with open(jsonFile, "r") as f:
    jsonData = json.load(f)

val_jsonFile = '/home/zg/dataset/IAPRTC12/test.json'
...
indexDict_ = check_file_exist(result[0], file_path='/home/zg/dataset/IAPRTC12/images')
val_indexDict_ = check_file_exist(val_result[0], file_path='/home/zg/dataset/IAPRTC12/images')
index_1 = []
index_2 = []
...
captions_path = '/home/zg/dataset/IAPRTC12/captions'
image_name_1 = []
...
# 使用 reshape 改变形状
captions_reshaped = captions_array.reshape((19626, 1))

#captions = captions.reshape(19626,1)
labelslist = {"category": labels}
indexslist = {"index": indexs}
captionlist = {"caption": captions_reshaped}

scio.savemat('/home/zg/zcc/CMH/OUR-DNPH-main/dataset/IAPR/label.mat', labelslist)
scio.savemat('/home/zg/zcc/CMH/OUR-DNPH-main/dataset/IAPR/index.mat', indexslist)
scio.savemat('/home/zg/zcc/CMH/OUR-DNPH-main/dataset/IAPR/caption.mat', captionlist)