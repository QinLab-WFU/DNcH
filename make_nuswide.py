...
root_dir = "/home/zg/dataset/nuswide"
...
imagePath = os.path.join("/home/zg/dataset/nuswide/Flickr")
...
with open("/home/zg/dataset/nuswide/Groundtruth/used_label.txt", encoding='utf-8') as f:
...
not_used_id = []
with open("/home/zg/dataset/nuswide/Groundtruth/not_used_id.txt", encoding='utf-8') as f:
...
scio.savemat('/home/zg/zcc/CMH/OUR-DNPH-main/dataset/nuswide/index.mat', indexs)
# scio.savemat("caption.mat", captions)
scio.savemat('/home/zg/zcc/CMH/OUR-DNPH-main/dataset/nuswide/label.mat', labels)


captions = [item + "\n" for item in captions["caption"]]

with open('/home/zg/zcc/CMH/OUR-DNPH-main/dataset/nuswide/caption.txt', "w", encoding='utf-8') as f:
