...
if __name__ == "__main__":
    ...
    parser.add_argument("--coco-dir", default="/home/zg/dataset/coco/coco2017", type=str, help="the coco dataset dir")
    parser.add_argument("--save-dir", default="./dataset/coco", type=str, help="mat file saved dir")
    ...
    scio.savemat("/home/zg/zcc/CMH/OUR-DNPH-main/dataset/coco/index.mat", indexs)
    scio.savemat("/home/zg/zcc/CMH/OUR-DNPH-main/dataset/coco/caption.mat", captions)
    scio.savemat("/home/zg/zcc/CMH/OUR-DNPH-main/dataset/coco/label.mat", categorys)
